...
Open-Source/LKING.py
@Mr-Qureshi-xd
Mr-Qureshi-xd Rename TATA.py to LKING.py
 1 contributor
708 lines (704 sloc)  49.6 KB
...
----------------------------------------------
 ...
 Version   : 1.0.0
----------------------------------------------
 AKING Pro version 1.0.0
 For Haters: Zindabad Afghanistan 💪🇦🇫🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi AFG Sir, I Need To Buy Your Paid AFG PRO Tools Version 1.0.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AFG-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
